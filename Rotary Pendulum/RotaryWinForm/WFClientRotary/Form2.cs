...
namespace WFClientRotary
{
    public partial class Form2 : Form
    {
        ...
        private unsafe void timer1_Tick(object sender, EventArgs e)
        {
            ...
            textBox1.Text = "Arm Rotation: " + pVal[3].ToString("0.00");
            
            textBox2.Text = "Plate Rotation: " + pVal[2].ToString("0.00");
            if (button1State)
            {
                xPos.Add(pVal[3].ToString("0.00"));
                zPos.Add(pVal[2].ToString("0.00"));
            }
        ...
        {
            var series = new Series("Arm Rotation");
            var series1 = new Series("Plate Rotation");
